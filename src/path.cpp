...
path path::filename() const { return path{filename_internal(*this)}; }

path path::stem() const { return stem_internal(*this).to_path(); }
...
bool path::has_stem() const noexcept { return !stem_internal(*this).empty(); }

bool path::has_extension() const noexcept { return !!extension_internal(*this); }
